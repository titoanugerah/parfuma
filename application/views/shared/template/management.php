...
<body>
	<div class="wrapper">
		<div class="main-header">
			<!-- Logo Header -->
			<div class="logo-header" data-background-color="<?php echo $this->config->item('management_background_color'); ?>">
			...
			<!-- Navbar Header -->
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="<?php echo $this->config->item('management_background_color'); ?>2">
